...
public class ModItemGroups {
    ...
    public static final ItemGroup TOOLS = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(ReinforcedTools.MOD_ID, "tools"),
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.STEEL_AXE))
                    .displayName(Text.translatable("itemgroup.reinforcedtools.tools"))
                    .entries((displayContext, entries) -> {
