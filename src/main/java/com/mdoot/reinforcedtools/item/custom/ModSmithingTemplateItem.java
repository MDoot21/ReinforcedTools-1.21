...
public class ModSmithingTemplateItem extends Item {
    ...
    private static final Text INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.ingredients")))
            .formatted(TITLE_FORMATTING);
    private static final Text APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.applies_to")))
            .formatted(TITLE_FORMATTING);
    private static final Text STEEL_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", Identifier.of("reinforcedtools", "steel_upgrade")))
            .formatted(TITLE_FORMATTING);
    private static final Text ARMOR_TRIM_APPLIES_TO_TEXT = Text.translatable(
                    Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.armor_trim.applies_to"))
            )
            .formatted(DESCRIPTION_FORMATTING);
    private static final Text ARMOR_TRIM_INGREDIENTS_TEXT = Text.translatable(
                    Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.armor_trim.ingredients"))
            )
            .formatted(DESCRIPTION_FORMATTING);
    private static final Text ARMOR_TRIM_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(
            Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.armor_trim.base_slot_description"))
    );
    private static final Text ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(
            Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.armor_trim.additions_slot_description"))
    );
    private static final Text STEEL_UPGRADE_APPLIES_TO_TEXT = Text.translatable(
                    Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.steel_upgrade.applies_to"))
            )
            .formatted(DESCRIPTION_FORMATTING);
    private static final Text STEEL_UPGRADE_INGREDIENTS_TEXT = Text.translatable(
                    Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.steel_upgrade.ingredients"))
            )
            .formatted(DESCRIPTION_FORMATTING);
    private static final Text STEEL_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(
            Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.steel_upgrade.base_slot_description"))
    );
    private static final Text STEEL_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(
            Util.createTranslationKey("item", Identifier.of("reinforcedtools", "smithing_template.steel_upgrade.additions_slot_description"))
    );
    ...
    public static net.minecraft.item.SmithingTemplateItem of(RegistryKey<ArmorTrimPattern> trimPattern, FeatureFlag... requiredFeatures) {
        return of(trimPattern.getValue(), requiredFeatures);
    }

    public static net.minecraft.item.SmithingTemplateItem of(Identifier trimPatternIn, FeatureFlag... requiredFeatures) {
    ...
    public static net.minecraft.item.SmithingTemplateItem createSteelUpgrade() {
        return new net.minecraft.item.SmithingTemplateItem(
                STEEL_UPGRADE_APPLIES_TO_TEXT,
                STEEL_UPGRADE_INGREDIENTS_TEXT,
                STEEL_UPGRADE_TEXT,
                STEEL_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT,
                STEEL_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT,
                getSteelUpgradeEmptyBaseSlotTextures(),
                getSteelUpgradeEmptyAdditionsSlotTextures()
        );
    }
    ...
    private static List<Identifier> getSteelUpgradeEmptyBaseSlotTextures() {
        return List.of(
    ...
    private static List<Identifier> getSteelUpgradeEmptyAdditionsSlotTextures() {
